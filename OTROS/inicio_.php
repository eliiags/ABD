		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li id="entrada" class="active"><a href="#">Bandeja de entrada <span class="badge badge-info">4</span></a></li>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<p class="h1 page-header">Bandeja de entrada</p>
				...
				<div class="panel_mensajes">
					...
					<?php
						...
						if (isset($_SESSION['usuario'])){
							...
							$comprobar = mysql_query("SELECT * FROM usuarios JOIN mensajes ON id_rem = id_usuario  WHERE id_rem <> (SELECT id_usuario FROM usuarios WHERE nombre_usuario='$usuario_actual' OR email='$usuario_actual') AND id_dest = (SELECT id_usuario FROM usuarios WHERE nombre_usuario='$usuario_actual' OR email='$usuario_actual')");
										...
										echo "<div class='panel panel-info'>
											...
											<div class='panel-body'>
												...
												<div class='pull-right'>
													<button type='button' class='btn btn-info' id='resp'>Responder</button>
